...
<b style="background-color: #ffd60a;">1. Problem:</b> Currently about 25% of all municipal solid waste (MSW) goes uncollected - more than 500 million tonnes per year.
...
<b style="background-color: #ffd60a;">8. Key Metrics: we are trying to reduce these quantifiable negative impact</b>
...
<b style="background-color: #ffd60a;">3. Unique Value Proposition: </b>
...
<b style="background-color: #ffd60a;">4. Solution part 1: </b>
...
<b style="background-color: #ffd60a;">5. Channels: </b>
...
The connection is inadequate between the global vision and the micro level actions and tools.
<b style="background-color: #ffd60a;">4. Solution part 2: </b>
...
<b style="background-color: #ffd60a;">4. Solution part 3: </b>
...
<b style="background-color: #ffd60a;">6. Revenue Streams: </b>
...
<b style="background-color: #ffd60a;">9. Unfair Advantage: </b>
...
<b style="background-color: #ffd60a;">4. Solution part 4: </b>
...
<b style="background-color: #ffd60a;">2. Customer Segments: There are no customers, our aim is to implement large systems change.</b> 

<b style="background-color: #ffd60a;">7. Cost Structure - salaries of employees only. If using Tech Zero model, then only survival salary for myself.</b> 
